...
class BankAccountService {
    ...
    async getAllBankAccounts() {
        try {
            ...
            logger_1.logger.error('Error in getAllBankAccounts:', error);
    ...
    async getBankAccountById(id) {
        try {
            ...
            logger_1.logger.error('Error in getBankAccountById:', error);
            throw new Error('銀行口座の取得に失敗しました');
        }
    }
    /**
    ...
    async createBankAccount(accountData) {
        try {
            ...
            logger_1.logger.error('Error in createBankAccount:', error);
    ...
    async updateBankAccount(id, updateData) {
        try {
            ...
            logger_1.logger.error('Error in updateBankAccount:', error);
    ...
    async deleteBankAccount(id) {
        try {
            ...
            logger_1.logger.error('Error in deleteBankAccount:', error);
    ...
    async getDefaultAccount() {
        try {
            ...
            logger_1.logger.error('Error in getDefaultAccount:', error);
    ...
    async unsetDefaultAccounts(excludeId) {
        try {
            ...
            logger_1.logger.error('Error in unsetDefaultAccounts:', error);
