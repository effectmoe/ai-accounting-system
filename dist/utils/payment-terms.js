...
exports.getPaymentTermsDescription = getPaymentTermsDescription;
...
function calculateDueDate(invoiceDate, paymentTerms) {
    ...
    if (normalizedTerms.includes('当月末締め翌月末払い') ||
        ...
        dueDate = (0, date_fns_1.endOfMonth)((0, date_fns_1.addMonths)(invoiceDate, 1));
    }
    // 当月末締め翌々月末払い
        ...
        dueDate = (0, date_fns_1.endOfMonth)((0, date_fns_1.addMonths)(invoiceDate, 2));
    }
    // 翌月10日払い、翌月15日払いなど
        ...
        if (match) {
            ...
            // 翌月の指定日を支払期限とする
            dueDate = (0, date_fns_1.setDate)((0, date_fns_1.addMonths)(invoiceDate, 1), day);
        }
    }
    // 翌々月10日払い、翌々月15日払いなど
        ...
        if (match) {
            const day = parseInt(match[1]);
            // 翌々月の指定日を支払期限とする
            dueDate = (0, date_fns_1.setDate)((0, date_fns_1.addMonths)(invoiceDate, 2), day);
        }
    }
    // 即日払い
    ...
    // 月末払い（当月末）
        ...
        dueDate = (0, date_fns_1.endOfMonth)(invoiceDate);
    }
    return dueDate;
}
/**
