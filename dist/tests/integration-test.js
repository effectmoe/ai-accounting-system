...
const mastra_orchestrator_test_1 = require("../src/mastra-orchestrator-test");
const nlp_orchestrator_1 = require("../src/nlp-orchestrator");
...
async function testNLPOrchestrator() {
    ...
    for (const testCase of testCases) {
        try {
            ...
            const result = await nlp_orchestrator_1.nlpOrchestrator.processNaturalLanguage(testCase.input, {
...
async function testIndividualAgents(orchestrator) {
...
async function testCompleteWorkflow(orchestrator) {
...
async function runIntegrationTests() {
    ...
    try {
        ...
        const orchestrator = new mastra_orchestrator_test_1.MastraOrchestrator();
        // Run tests
        try {
