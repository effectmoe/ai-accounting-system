...
async function GET(request) {
    try {
        ...
        logger_1.logger.debug('GET response - Key fields:', {
...
async function POST(request) {
    try {
        ...
        logger_1.logger.error('Error saving company info:', error);
        return server_1.NextResponse.json({
            success: false,
    ...
    try {
        ...
        if (!isSpeechSettingsOnly) {
            ...
            if (!existingInfo) {
                ...
                logger_1.logger.debug('Creating minimal company info for speech settings');
        ...
        // デバッグログ
        logger_1.logger.debug('PUT request body:', {
            ...body,
        ...
        logger_1.logger.debug('Prepared update data:', {
            ...updateData,
