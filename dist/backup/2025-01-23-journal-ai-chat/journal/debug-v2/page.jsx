...
exports.default = DebugV2Page;
const react_1 = require("react");
function DebugV2Page() {
    ...
    (0, react_1.useEffect)(() => {
        ...
        addLog(`React version: ${react_1.useState ? 'Loaded' : 'Not loaded'}`);
    ...
    return (<div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <button onClick={() => alert('Alert works!')} style={{
            padding: '10px 20px',
            fontSize: '16px',
        ...
        <button onClick={testAPI} disabled={isLoading} style={{
            padding: '10px 20px',
            fontSize: '16px',
      ...
      {/* API Response */}
      {apiResponse && (<div style={{ marginBottom: '20px', backgroundColor: '#e8f5e9', padding: '10px', borderRadius: '4px' }}>
          <h2>API Response</h2>
