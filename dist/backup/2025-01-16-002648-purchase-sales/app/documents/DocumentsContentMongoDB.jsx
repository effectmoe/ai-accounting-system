    ...
    return (<div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-4 bg-white rounded-lg shadow p-4">
        ...
        {viewMode === 'grid' ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredDocuments.map((doc) => (<div key={doc.id} className="bg-white border rounded-lg p-4 hover:shadow-lg transition-shadow relative">
            ...
            <table className="w-full">
              ...
              <tbody>
                {filteredDocuments.map((doc) => (<tr key={doc.id} className="border-b hover:bg-gray-50">
                    <td className="p-2">
