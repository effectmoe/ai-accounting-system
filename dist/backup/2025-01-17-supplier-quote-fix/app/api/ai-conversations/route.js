...
async function GET(request) {
    try {
        ...
        if (!conversation) {
            ...
            console.log('[AI Conversations API - GET] No conversation found. Sample conversations:', allConversations.map(c => ({
            ...
            if (invoiceId) {
                ...
                console.log('[AI Conversations API - GET] Search by invoiceId pattern:', searchByInvoiceId.map(c => ({
                    conversationId: c.conversationId,
                    invoiceId: c.invoiceId
                })));
            }
