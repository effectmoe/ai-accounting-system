...
exports.ACCOUNT_CATEGORY_RULES = void 0;
exports.determineAccountCategory = determineAccountCategory;
exports.getKeywordsByCategory = getKeywordsByCategory;
exports.addKeywordToCategory = addKeywordToCategory;
exports.ACCOUNT_CATEGORY_RULES = [
    {
        category: '車両費',
        priority: 95,
        keywords: [
 ...
 * ベンダー名から勘定科目を判定
 */
function determineAccountCategory(vendorName) {
    const vendorLower = vendorName.toLowerCase();
    // 優先度順にソート
    const sortedRules = [...exports.ACCOUNT_CATEGORY_RULES].sort((a, b) => (b.priority || 0) - (a.priority || 0));
    // ルールを順番にチェック
...
function getKeywordsByCategory(category) {
    const rule = exports.ACCOUNT_CATEGORY_RULES.find(r => r.category === category);
