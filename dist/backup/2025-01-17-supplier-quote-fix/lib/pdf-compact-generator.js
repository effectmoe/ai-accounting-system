...
exports.generateSafeFilename = exports.generateInvoiceFilename = void 0;
exports.generateCompactInvoiceHTML = generateCompactInvoiceHTML;
function generateCompactInvoiceHTML(invoice, companyInfo) {
...
// ファイル名生成関数は既存のものを再利用
var pdf_html_generator_1 = require("./pdf-html-generator");
Object.defineProperty(exports, "generateInvoiceFilename", { enumerable: true, get: function () { return pdf_html_generator_1.generateInvoiceFilename; } });
Object.defineProperty(exports, "generateSafeFilename", { enumerable: true, get: function () { return pdf_html_generator_1.generateSafeFilename; } });
