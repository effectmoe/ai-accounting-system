...
const mongodb_client_js_1 = require("../lib/mongodb-client.js");
class SystemHealthChecker {
    ...
    async checkMongoDBConnection() {
        ...
        try {
            this.db = mongodb_client_js_1.DatabaseService.getInstance();
            // 接続テスト
            const client = await (0, mongodb_client_js_1.getClientPromise)();
            const db = await (0, mongodb_client_js_1.getDatabase)();
            await db.admin().ping();
            result.status = 'PASS';
            ...
            const definedCollections = Object.values(mongodb_client_js_1.Collections);
     ...
     */
    async checkAgentMongoDBCompliance() {
     ...
     */
    async checkWorkflowMongoDBCompliance() {
