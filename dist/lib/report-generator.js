...
class ReportGenerator {
    ...
    static async generateSalesReport(companyId, startDate, endDate) {
        ...
        try {
            ...
            logger_1.logger.error('Error generating sales report:', error);
            throw error;
        }
    }
    /**
    ...
    static async generateJournalReport(companyId, startDate, endDate) {
        ...
        try {
            ...
            logger_1.logger.error('Error generating journal report:', error);
            throw error;
        }
    }
    /**
    ...
    static async generateTaxReport(companyId, startDate, endDate) {
        ...
        try {
            ...
            logger_1.logger.error('Error generating tax report:', error);
            throw error;
        }
    }
    // ヘルパーメソッド
