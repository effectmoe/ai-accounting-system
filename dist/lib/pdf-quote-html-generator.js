...
exports.generateCompactQuoteHTML = generateCompactQuoteHTML;
exports.generateQuoteFilename = generateQuoteFilename;
exports.generateSafeQuoteFilename = generateSafeQuoteFilename;
function generateCompactQuoteHTML(quote, companyInfo) {
...
function generateQuoteFilename(quote) {
...
function generateSafeQuoteFilename(quote) {
    const issueDate = new Date(quote.issueDate || new Date());
    const dateStr = issueDate.toISOString().split('T')[0].replace(/-/g, '');
    const customerName = quote.customer?.companyName ||
        quote.customer?.name ||
