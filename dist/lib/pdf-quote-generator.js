...
function addJapaneseFont(doc) {
    ...
    try {
        ...
        logger_1.logger.warn('Font setting error, using default font:', error);
    }
}
// 日本語テキストの分割処理
function splitJapaneseText(doc, text, maxWidth) {
...
async function generateQuotePDF(quote, companyInfo) {
    return new Promise((resolve, reject) => {
        try {
            ...
            doc.setFontSize(10);
            doc.setFont('helvetica', 'normal');
            doc.text('Thank you for your business / ご検討のほど、よろしくお願いいたします。', margin, footerY);
            // PDFを生成してBufferとして返す
