...
class FirecrawlClient {
    ...
    constructor(apiKey) {
        ...
        if (!this.apiKey) {
            logger_1.logger.warn('Firecrawl API key not provided. Web scraping functionality will be limited.');
        }
    }
    async scrape(request) {
        ...
        try {
            ...
            logger_1.logger.error('Firecrawl scrape error:', error);
            return {
                success: false,
    ...
    async crawl(request) {
        ...
        try {
            ...
            logger_1.logger.error('Firecrawl crawl error:', error);
            return {
                success: false,
    ...
    async search(request) {
        ...
        try {
            ...
            logger_1.logger.error('Firecrawl search error:', error);
            return {
                success: false,
...
//# sourceMappingURL=firecrawl-client.js.map