          ...
          {status !== 'paid' && (
            ...
            >
              ...
              支払記録
                    ...
                    logger_1.logger.error('Component generation error:', error);
                    return {
                        success: false,
                        error: error.message
                    };
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        `).join('')}
                    ...
                    logger_1.logger.error('Dashboard creation error:', error);
                    return {
                        success: false,
                        error: error.message
                    };
    ...
    extend: {
      ...
      fontFamily: {
        sans: ['Inter', 'Noto Sans JP', 'sans-serif'],
                    ...
                    logger_1.logger.error('Design system generation error:', error);
                    return {
                        success: false,
                        error: error.message
                    };
...
export default function ${pageName.replace(/\s+/g, '')}Page() {
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        `).join('')}
                    ...
                    logger_1.logger.error('Page generation error:', error);
                    return {
                        success: false,
                        error: error.message
                    };
        ...
        optimizeUIPerformance: {
            ...
            execute: async ({ componentPath, companyId }) => {
                try {
                    ...
                    logger_1.logger.error('UI optimization error:', error);
                    return {
                        success: false,
                        error: error.message
                    };
    ...
    execute: async ({ input, tools }) => {
        try {
            logger_1.logger.debug('[UI Agent] Starting operation:', input.operation);
            ...
            logger_1.logger.error('[UI Agent] Error:', error);
            return {
                success: false,
                error: error.message
            };
