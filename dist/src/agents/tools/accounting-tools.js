...
exports.accountingTools = exports.analyzeExpensesTool = exports.calculateTaxTool = exports.generateFinancialReportTool = exports.createInvoiceTool = exports.createJournalEntryTool = exports.categorizeTransactionTool = void 0;
...
exports.categorizeTransactionTool = {
    ...
    handler: async (params) => {
        logger_1.logger.info('Categorizing transaction:', params);
        let category = '未分類';
...
exports.createJournalEntryTool = {
    ...
    handler: async (params) => {
        logger_1.logger.info('Creating journal entry:', params);
...
exports.createInvoiceTool = {
    ...
    handler: async (params) => {
        logger_1.logger.info('Creating invoice via Mastra:', params);
        ...
        const invoiceData = {
            ...
            issueDate: new Date(),
            dueDate: params.due_date ? new Date(params.due_date) : new Date(Date.now() + 30 * 24 * 60 * 60 * 1000),
            subtotal: subtotal,
            taxAmount: taxAmount,
...
exports.generateFinancialReportTool = {
    ...
    handler: async (params) => {
        logger_1.logger.info('Generating financial report:', params);
        const db = await (0, mongodb_client_1.getDatabase)();
...
exports.calculateTaxTool = {
    ...
    handler: async (params) => {
        logger_1.logger.info('Calculating tax:', params);
        let taxAmount = 0;
        let effectiveRate = 0;
        let calculation = {};
...
exports.analyzeExpensesTool = {
    ...
    handler: async (params) => {
        logger_1.logger.info('Analyzing expenses:', params);
        const db = await (0, mongodb_client_1.getDatabase)();
...
//# sourceMappingURL=accounting-tools.js.map