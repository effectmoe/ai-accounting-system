...
exports.default = GitHubSection;
const react_1 = require("react");
function GitHubSection() {
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    const [message, setMessage] = (0, react_1.useState)('');
    const [reportDates, setReportDates] = (0, react_1.useState)({
    ...
    return (<div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="border rounded p-4">
          ...
          <button onClick={saveLogs} disabled={isLoading} className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:bg-gray-400">
            サンプルログを保存
          </button>
        </div>
        ...
        <div className="border rounded p-4">
          ...
          <div className="flex gap-2">
            <button onClick={releaseVersion} disabled={isLoading} className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 disabled:bg-gray-400">
              新バージョンをリリース
            </button>
            <button onClick={getLatestVersion} disabled={isLoading} className="px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-700 disabled:bg-gray-400">
              最新バージョン確認
            </button>
          </div>
        </div>
        ...
        <div className="border rounded p-4">
          ...
          <div className="flex gap-2 mb-3">
            <input type="date" value={reportDates.start} onChange={(e) => setReportDates({ ...reportDates, start: e.target.value })} className="px-3 py-2 border rounded"/>
            <span className="py-2">〜</span>
            <input type="date" value={reportDates.end} onChange={(e) => setReportDates({ ...reportDates, end: e.target.value })} className="px-3 py-2 border rounded"/>
          </div>
          <button onClick={generateReport} disabled={isLoading} className="px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 disabled:bg-gray-400">
            レポート生成
          </button>
        </div>

        {/* メッセージ表示 */}
        {message && (<div className={`p-3 rounded ${message.startsWith('✅') ? 'bg-green-100 text-green-800' :
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="space-y-2 text-sm">
            <div>
              ...
              <a href="https://github.com/effectmoe/aam-logs/tree/main/logs/aam-system" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                /logs/aam-system/YYYY/MM/logs-YYYY-MM-DD.json
              </a>
            </div>
            <div>
              <span className="text-gray-600">バージョン: </span>
              <a href="https://github.com/effectmoe/aam-logs/tree/main/versions/aam-system" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                /versions/aam-system/vX.X.X.json
              </a>
            </div>
            <div>
              <span className="text-gray-600">レポート: </span>
              <a href="https://github.com/effectmoe/aam-logs/tree/main/reports/aam-system" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                /reports/aam-system/report-開始日-to-終了日.json
              </a>
            </div>
            <div className="mt-2">
              <span className="text-gray-600">リポジトリ: </span>
              <a href="https://github.com/effectmoe/aam-logs" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium">
