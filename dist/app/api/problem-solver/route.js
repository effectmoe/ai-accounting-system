...
async function POST(request) {
    try {
        ...
        logger_1.logger.debug('Problem Solver API - Request:', {
            operation: operation,
        ...
        logger_1.logger.debug('Problem Solver API - Result:', {
        ...
        logger_1.logger.error('Problem Solver API Error:', error);
...
async function GET(request) {
    try {
        ...
        logger_1.logger.error('Problem Solver GET API Error:', error);
        return server_1.NextResponse.json({
            success: false,
