...
async function POST(request) {
    try {
        ...
        try {
            ...
            await activity_log_service_1.ActivityLogService.logInvoiceCreated(invoice._id.toString(), customerName, invoice.totalAmount);
            logger_1.logger.info('Activity log recorded for invoice creation');
        }
        catch (logError) {
            logger_1.logger.error('Failed to log activity for invoice creation:', logError);
        }
