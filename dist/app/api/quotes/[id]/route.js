...
async function GET(request, { params }) {
    try {
        const { id } = params;
        logger_1.logger.debug('[GET /api/quotes/[id]] Quote ID:', id);
...
async function PUT(request, { params }) {
    try {
        ...
        logger_1.logger.debug('[PUT /api/quotes/[id]] Quote ID:', id);
        logger_1.logger.debug('[PUT /api/quotes/[id]] Update data:', JSON.stringify(body, null, 2));
        const quoteService = new quote_service_1.QuoteService();
...
async function DELETE(request, { params }) {
    try {
        const { id } = params;
        logger_1.logger.debug('[DELETE /api/quotes/[id]] Quote ID:', id);
        const quoteService = new quote_service_1.QuoteService();
