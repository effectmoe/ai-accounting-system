...
async function AccountsPage() {
    ...
    try {
        ...
        logger_1.logger.error('Error fetching accounts:', error);
        // エラー時はモックデータを使用
        accounts = [
    ...
    return (<div className="container mx-auto py-8">
      ...
      {Object.entries(groupedAccounts).map(([type, accountList]) => (<div key={type} className="mb-8">
          <h2 className="text-xl font-semibold mb-4 text-gray-700">
            {typeLabels[type] || type} ({accountList.length}科目)
          </h2>
          ...
          <div className="bg-white shadow overflow-hidden rounded-lg">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {accountList.map((account) => (<tr key={account.id} className="hover:bg-gray-50">
