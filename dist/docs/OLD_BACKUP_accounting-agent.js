...
exports.accountingAgent = void 0;
...
// 会計エージェントの入力スキーマ
const accountingInputSchema = zod_1.z.object({
    // 自然言語入力
    naturalLanguageInput: zod_1.z.string().optional(),
    // 構造化入力（OCRから）
    structuredInput: zod_1.z.object({
        vendor: zod_1.z.string(),
        amount: zod_1.z.number(),
        date: zod_1.z.string(),
        description: zod_1.z.string(),
        category: zod_1.z.string().optional(),
        ocrResultId: zod_1.z.string().optional(),
    }).optional(),
    // 処理タイプ
    processType: zod_1.z.enum(['journal_entry', 'tax_calculation', 'report_generation']),
    // レポートオプション
    reportOptions: zod_1.z.object({
        type: zod_1.z.enum(['trial_balance', 'balance_sheet', 'profit_loss', 'journal']),
        period: zod_1.z.object({
            startDate: zod_1.z.string(),
            endDate: zod_1.z.string(),
        }),
        format: zod_1.z.enum(['google_sheets', 'excel', 'pdf', 'csv']),
    }).optional(),
});
// 会計エージェント定義
exports.accountingAgent = (0, core_1.createAgent)({
    id: 'accounting-agent',
...
// エージェントのエクスポート
exports.default = exports.accountingAgent;
