...
import { ArrowLeft, Edit, Trash2, FileText, Building, Calendar, DollarSign, CheckCircle, Clock, CreditCard, Download } from 'lucide-react';
...
export default function PurchaseInvoiceDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* OCR元ファイル */}
      {(invoice.ocrResultId || invoice.fileId) && (
        <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-2">
                {invoice.fileId && (
                  <>
                    <a
                      href={`/api/documents/${invoice.fileId}/download`}
                      target="_blank"
                ...
                {invoice.ocrResultId && (
                  <a
                    href={`/api/ocr-results/${invoice.ocrResultId}`}
                    target="_blank"
                    rel="noopener noreferrer"
