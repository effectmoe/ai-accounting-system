...
export default function NewJournalPage() {
  ...
  const handleSubmit = async () => {
    ...
    const validLines = lines.filter(line => 
      line.accountCode && line.accountName && (line.debitAmount > 0 || line.creditAmount > 0)
    );
              ...
              {lines.map((line, index) => (
                <div key={index} className="grid grid-cols-12 gap-2 items-end">
                  <div className="col-span-2">
                    <Label className="text-xs">勘定科目コード</Label>
                    <Input
                  ...
                  <div className="col-span-3">
                    <Label className="text-xs">勘定科目名</Label>
                    <Input
                  ...
                  <div className="col-span-2">
                    <Label className="text-xs">借方金額</Label>
                    <Input
                      type="number"
                      value={line.debitAmount || ''}
                      onChange={(e) => updateLine(index, 'debitAmount', Number(e.target.value))}
                      placeholder="0"
                    />
                  </div>
                  <div className="col-span-2">
                    <Label className="text-xs">貸方金額</Label>
                    <Input
                      type="number"
                      value={line.creditAmount || ''}
                      onChange={(e) => updateLine(index, 'creditAmount', Number(e.target.value))}
                      placeholder="0"
                    />
                  </div>
                  <div className="col-span-2">
