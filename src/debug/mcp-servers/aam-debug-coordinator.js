 ...
 * - 全エージェント健康状態監視
 * - Azure Form Recognizer + GAS OCR統合分析
...
class AAMDebugCoordinator {
      ...
      return {
        tools: [
          ...
          },
          {
            ...
            description: 'OCRエージェント（Azure + GAS）のパフォーマンス分析',
            inputSchema: {
              type: 'object',
              properties: {
                timeRange: {
  ...
  async checkSystemHealth() {
    ...
    const envCheck = {
      ...
      gasOcr: !!process.env.GAS_OCR_URL
    };
          ...
          text: JSON.stringify({
            ...
            systemHealth: {
              ...
              services: {
                ...
                gasOCR: await this.checkGASOCRStatus(),
  ...
  async analyzeOCRPerformance() {
    ...
    const performanceData = {
      ...
      gasOCRFallback: {
        ...
        successRate: '94.2%',
        usageRate: '15%',
        fallbackReasons: ['azure_timeout', 'azure_error', 'cost_optimization']
      },
      recommendations: [
  ...
  async analyzeCommunicationFlow() {
    return {
      ...
      missingConnections: {
        'OCRProcessor': ['Azure Form Recognizer', 'GAS OCR', 'AI Classification'],
